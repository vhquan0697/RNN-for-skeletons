    ...
    def train_lstm_model(self):
        ...
        for epoch in range( self._param['max_iter'] ):
            ...
            for x, y in self.iterate_minibatches(trainX, trainY, self._param['batchsize']):
                ...
                train_batches += 1
                print 'train loss : ' + train_loss + ', train batches : ' + train_batches
...
def run_model():
    ...
    param['trn_arr_file'] = 'data/subj_seq/array_list_train.h5'
    param['trn_lst_file'] = 'data/subj_seq/file_list_train.txt'
    ...
    param['save_path'] = 'data/subj_seq/save_param/part' # save prefix, part_hier
